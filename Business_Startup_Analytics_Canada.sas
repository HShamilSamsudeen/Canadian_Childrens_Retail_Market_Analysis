...
libname mylib '/home/u50059513/Group Project/Data';
...
PROC EXPORT 
	...
	dbms = xlsx 
	outfile = "/home/u50059513/Group Project/Output Data/Top10_Cities2011.xlsx" 
	replace;
RUN;
...
PROC EXPORT 
	data = Census_Percentage_2011 
	dbms = xlsx 
	outfile = "/home/u50059513/Group Project/Output Data/Census_Percentage_2011.xlsx" 
	replace;
RUN;
...
PROC EXPORT 
	...
	dbms = xlsx 
	outfile = "/home/u50059513/Group Project/Output Data/Top10_Cities2016.xlsx" 
	replace;
RUN;
...
PROC EXPORT 
	data = Census_Percentage_2016 
	dbms = xlsx 
	outfile = "/home/u50059513/Group Project/Output Data/Census_Percentage_2016.xlsx" 
	replace;
RUN;
...
PROC EXPORT 
	...
	dbms = xlsx 
	outfile = "/home/u50059513/Group Project/Output Data/yearly_change_2011_2016.xlsx" 
	replace;
RUN;
...
PROC IMPORT datafile = '/home/u50059513/Group Project/Data/National_Average6006.xlsx' out = national_income 
	dbms=xlsx replace;
	getnames=yes;
RUN;
...
DATA income_source;
	set '/home/u50059513/Group Project/Data/income_source.sas7bdat';
RUN;
...
PROC IMPORT DATAFILE = '/home/u50059513/Group Project/Data/Language_Spoken_Cleaned_6071_v2.xlsx' OUT = mylib.Languages
DBMS = XLSX REPLACE;
	getnames = yes;
RUN;
...
PROC EXPORT 
	...
	dbms = xlsx 
	outfile = "/home/u50059513/Group Project/Output Data/Top10_Languages_Spoken.xlsx" 
	replace;
RUN;
...
PROC EXPORT 
	...
	dbms = xlsx 
	outfile = "/home/u50059513/Group Project/Output Data/Top10_Cities2016_15to19.xlsx" 
	replace;
RUN;
...
PROC EXPORT 
	data = Census_Percentage_0to19 
	dbms = xlsx 
	outfile = "/home/u50059513/Group Project/Output Data/Census_Percentage_0to19.xlsx" 
	replace;
RUN;